    ...
    <div className="w-full flex items-start justify-evenly gap-4">
      ...
      <div>
        <div>
          <ul className="flex flex-col gap-1">
            <li>
              <h1 className="text-slate-100 font-semibold">Product</h1>
            </li>
            <li>
      ...
      <div>
        <div>
          <ul className="flex flex-col gap-1">
            <li>
              <h1 className="text-slate-100 font-semibold">Company</h1>
            </li>
            <li>
              <Link to="#">About</Link>
            </li>
      ...
      <div>
        <div>
          <ul className="flex flex-col gap-1">
            <li>
              <h1 className="text-slate-100 font-semibold">Policies</h1>
            </li>
            <li>
              <Link to="#">Terms</Link>
            </li>
